    ...
    find: function find() {
      ...
      axios.post('/find', {
        ...
        if (response.data.status == 'success') {
          _this2.model2 = response.data.data;
          _this2.totalItems = _this2.model2.length;
          _this2.model3 = _this2.model2.slice((_this2.pagination1.currentPage - 1) * _this2.perPage, _this2.pagination1.currentPage * _this2.perPage);
        } else {
          _this2.response = response.data.message;
        }
      });
    }
  }
...
var render = function() {
  ...
  return _c("div", [
    ...
    _c("div", { staticClass: "form-group" }, [
      _c("label", [_vm._v("Тип пользователя")]),
      _vm._v(" "),
      _c(
        "select",
        {
          directives: [
            { name: "model", rawName: "v-model", value: _vm.f, expression: "f" }
          ],
          staticClass: "form-control",
          attrs: { name: "user_type_id" },
          on: {
            change: function($event) {
              ...
              _vm.f = $event.target.multiple ? $$selectedVal : $$selectedVal[0]
            }
          }
        },
        [
          _c("option", { attrs: { value: "" } }, [_vm._v("нет")]),
          _vm._v(" "),
    ...
    _vm._v(" "),
    _c("div", { staticClass: "form-group" }, [
      _c("label", [_vm._v("Блок с чекбоксами")]),
      _vm._v(" "),
      _c(
        "ul",
        _vm._l(_vm.checkboxArr[_vm.f], function(value, key) {
          return _c("li", [
                  ...
                  change: function($event) {
                    ...
                    if (Array.isArray($$a)) {
                      var $$v = null,
                        $$i = _vm._i($$a, $$v)
                      if ($$el.checked) {
                        $$i < 0 && _vm.$set(value, "checked", $$a.concat([$$v]))
                      } else {
                        $$i > -1 &&
                          _vm.$set(
                            value,
...
var staticRenderFns = [
  ...
  function() {
    ...
    return _c("div", { staticClass: "form-group" }, [
      ...
      _c("input", {
        staticClass: "form-control",
        attrs: { type: "date", name: "birthday_date" }
      })
    ])
  },
  function() {
    ...
    var _c = _vm._self._c || _h
    return _c("div", { staticClass: "form-group" }, [
      _c("label", [_vm._v("Организация")]),
      _vm._v(" "),
      _c("input", {
        staticClass: "form-control",
        attrs: { type: "text", name: "organization" }
      })
    ])
  }
]
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.model2.full_name,
            expression: "model2.full_name"
          }
        ],
        staticClass: "form-control",
        attrs: { type: "text", name: "full_name" },
        domProps: { value: _vm.model2.full_name },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.model2, "full_name", $event.target.value)
          }
        }
      })
    ]),
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.model2.birthday_date,
            expression: "model2.birthday_date"
          }
        ],
        staticClass: "form-control",
        attrs: { type: "date", name: "birthday_date" },
        domProps: { value: _vm.model2.birthday_date },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.model2, "birthday_date", $event.target.value)
          }
        }
      })
    ]),
        ...
        directives: [
          {
            name: "model",
            rawName: "v-model",
            value: _vm.model2.organization,
            expression: "model2.organization"
          }
        ],
        staticClass: "form-control",
        attrs: { type: "text", name: "organization", disabled: "" },
        domProps: { value: _vm.model2.organization },
        on: {
          input: function($event) {
            if ($event.target.composing) {
              return
            }
            _vm.$set(_vm.model2, "organization", $event.target.value)
          }
        }
      })
    ]),
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _vm._v(" "),
      _c("div", { staticClass: "input-group form-group" }, [
        _c("span", { staticClass: "input-group-addon" }, [_vm._v("С")]),
        _vm._v(" "),
        _c("input", {
          directives: [
            {
        ...
        _vm._v(" "),
        _c("span", { staticClass: "input-group-addon" }, [_vm._v("По")]),
        _vm._v(" "),
        _c("input", {
          directives: [
            {
      ...
      _c("table", { staticClass: "table table-hover table-sm" }, [
        ...
        _c(
          "tbody",
          [
            _vm._l(_vm.model3, function(value, key) {
              return _c("tr", [
                _c("td", { staticClass: "align-middle" }, [
                  _vm._v(_vm._s(value.full_name))
                ]),
                _vm._v(" "),
                _c("td", { staticClass: "align-middle" }, [
                ...
                _vm._v(" "),
                _c("td", { staticClass: "align-middle" }, [
                  _vm._v(_vm._s(value.user_type_title))
                ]),
                _vm._v(" "),
                _c("td", [
                  _c("div", { staticClass: "form-group" }, [
                    ...
                    _c(
                      "ul",
                      _vm._l(value.role_obj, function(value2, key2) {
                        return _c("li", [
                          _c("div", { staticClass: "form-check" }, [
                            _c("input", {
                              directives: [
                              ...
                              attrs: {
                                type: "checkbox",
                                id:
                                  "check_user_id_" + value.id + "_pos_" + key2,
                                name: "role[" + value2.id + "]"
                              },
                              domProps: {
                                checked: Array.isArray(value2.checked)
                                  ? _vm._i(value2.checked, null) > -1
                                  : value2.checked
                              },
                              on: {
                                change: function($event) {
                                  var $$a = value2.checked,
                                    $$el = $event.target,
                                    $$c = $$el.checked ? true : false
                                  if (Array.isArray($$a)) {
                                    var $$v = null,
                ...
                _c("td", [
                  _c(
                    "button",
                    {
                      ...
                      on: {
                        click: function($event) {
                          return _vm.deleteItem(value.id)
                        }
                      }
                    },
      ...
      _c("uib-pagination", {
        tag: "div",
        attrs: { "total-items": _vm.totalItems, "items-per-page": _vm.perPage },
        on: {
          change: function($event) {
        ...
        model: {
          value: _vm.pagination1,
          callback: function($$v) {
            _vm.pagination1 = $$v
          },
          expression: "pagination1"
        }
      })
    ],
    1
...
var staticRenderFns = [
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", { staticClass: "align-middle" }, [_vm._v("ФИО")]),
        _vm._v(" "),
        _c("th", { staticClass: "align-middle" }, [_vm._v("Время создания")]),
        _vm._v(" "),
        _c("th", { staticClass: "align-middle" }, [_vm._v("Тип пользователя")]),
        _vm._v(" "),
        _c("th", { staticClass: "align-middle" }, [_vm._v("Роли")]),
        _vm._v(" "),
...
/***/ "./node_modules/vuejs-uib-pagination/dist/vuejs-uib-pagination.js":
/*!************************************************************************!*\
  !*** ./node_modules/vuejs-uib-pagination/dist/vuejs-uib-pagination.js ***!
  \************************************************************************/
/*! no static exports found */
...
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('edit', __webpack_require__(/*! ./components/edit.vue */ "./resources/js/components/edit.vue")["default"]);
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('create', __webpack_require__(/*! ./components/create.vue */ "./resources/js/components/create.vue")["default"]);
vue__WEBPACK_IMPORTED_MODULE_0___default.a.component('index', __webpack_require__(/*! ./components/index.vue */ "./resources/js/components/index.vue")["default"]); // Vue.component('pagination', Pagination);
...
__webpack_require__(/*! /home/grigorie/Projects/omega.local/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/grigorie/Projects/omega.local/resources/sass/app.scss */"./resources/sass/app.scss");
